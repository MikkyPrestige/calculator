    ...
    <div className='app'>
      ...
      <div className='app-container'>
        ...
        <div className='operators'>
          ...
          <button onClick={factorial} className='operator factorial'>n!</button>
          ...
          <button onClick={percentage} className='operator divide'>%</button>
          <button onClick={() => updateCalc('*')} className='operator multiply'>x</button>
          <button onClick={() => updateCalc('/')} className='operator divide'>÷</button>
          <button onClick={() => updateCalc('-')} className='operator minus'>-</button>
          <button onClick={() => updateCalc('+')} className='operator plus'>+</button>
          <button onClick={calculate} className='operator equalTo'>=</button>
          <button onClick={reciprocal} className='operator reciprocal'>1/x</button>
          <button onClick={cubeRoot} className='operator cubeRoot'>3√</button>
          <button onClick={() => updateCalc('==')} className='operator equal'>==</button>
          <button onClick={() => updateCalc('<')} className='operator greater'>{'<'}</button>
          <button onClick={() => updateCalc('>')} className='operator less'>{'>'}</button>
          <button onClick={() => updateCalc('<=')} className='operator greaterTo'>{'<='}</button>
          <button onClick={() => updateCalc('>=')} className='operator lessTo'>{'>='}</button>
          <button onClick={() => updateCalc('!=')} className='operator notequal'>{'!='}</button>
          <button onClick={radian} className='operator radian'>rad</button>
          <button onClick={degree} className='operator degree'>deg</button>
          <button onClick={radius} className='operator radius'>R</button>
          ...
          <button onClick={hyp} className='operator hyp'>hyp</button>
          <button onClick={() => updateCalc('%')} className='operator modulo'>mod</button>
          <button onClick={sinh} className='operator sinH'>sinh</button>
          <button onClick={cosh} className='operator cosH'>cosh</button>
          <button onClick={tanh} className='operator tanH'>tanh</button>
          ...
          <button onClick={random} className='operator random'>random</button>
          <button onClick={expm1} className='operator exp'>exp(x)-1</button>
          <button onClick={log1p} className='operator log'>log(1+x)</button>
