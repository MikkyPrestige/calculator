    ...
    <div className='app'>
      ...
      <div className='app-container'>
        ...
        <div className='operators'>
          ...
          <button onClick={absolute} className='operator'>abs</button>
          ...
          <button onClick={variances} className='operator'>variance</button>
          ...
          <button onClick={trunc} className='operator'>trunc</button>
        </div>
      </div>
