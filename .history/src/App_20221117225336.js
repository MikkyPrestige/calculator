    ...
    <div className='app'>
      ...
      <div className='app-container'>
        ...
        <div className='operators'>
          ...
          <button onClick={asinh} className='operator sinH'>sinh<sup>-1</sup></button>
          <button onClick={acosh} className='operator coshH'>cosh<sup>-1</sup></button>
          <button onClick={atanh} className='operator tanH'>tanh<sup>-1</sup></button>
